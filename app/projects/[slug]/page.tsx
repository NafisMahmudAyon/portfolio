...
export default async function Page({
  params
    ...
    params: Promise<{ slug: 'landing-page-ui' | 'blog-x-ui' | 'aspect-ui' | 'comboblocks' | 'aspect-accordions' | 'accordion-editor' | 'envobyte-digital-services' | 'real-estate-agency' | 'travel-bangladesh' }>
}) {
